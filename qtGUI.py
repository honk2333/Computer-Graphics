...
from midpoint_parabola import Drawparabola
import aa
import linecut
...
class Ui_MainWindow(object):
    ...
    def drawparabola(self, MainWindow):
        a = (self.edit_parabola_a.value())
        h = int(self.edit_parabola_h.value())
        k = int(self.edit_parabola_k.value())
        Drawparabola(a, h, k)
    ...
    def setupUi(self, MainWindow):
        ...
        self.parabola_but = QtWidgets.QPushButton(self.centralwidget)
        self.parabola_but.setGeometry(QtCore.QRect(540, 490, 161, 81))
        self.parabola_but.setObjectName("parabola_but")
        self.aaa_but = QtWidgets.QPushButton(self.centralwidget)
        self.aaa_but.setGeometry(QtCore.QRect(440, 620, 161, 81))
        self.aaa_but.setObjectName("action_but")
        self.bbb_but = QtWidgets.QPushButton(self.centralwidget)
        self.bbb_but.setGeometry(QtCore.QRect(220, 620, 161, 81))
        self.bbb_but.setObjectName("bction_but")
        ...
        self.edit_parabola_a = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.edit_parabola_a.setGeometry(QtCore.QRect(250, 500, 62, 27))
        self.edit_parabola_a.setObjectName("edit_parabola_a")
        self.edit_parabola_h = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.edit_parabola_h.setGeometry(QtCore.QRect(340, 500, 62, 27))
        self.edit_parabola_h.setObjectName("edit_parabola_h")
        self.edit_parabola_k = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.edit_parabola_k.setGeometry(QtCore.QRect(340, 540, 62, 27))
        self.edit_parabola_k.setObjectName("edit_parabola_k")
        ...
        self.label_16.setGeometry(QtCore.QRect(170, 500, 54, 18))
        self.label_16.setObjectName("label_16")
        self.label_17 = QtWidgets.QLabel(self.centralwidget)
        self.label_17.setGeometry(QtCore.QRect(420, 500, 54, 18))
        self.label_17.setObjectName("label_17")
        self.label_18 = QtWidgets.QLabel(self.centralwidget)
        self.label_18.setGeometry(QtCore.QRect(420, 540, 54, 18))
        ...
        self.edit_parabola_a.setRange(0, 10)
        self.edit_parabola_h.setRange(-50, 50)
        self.edit_parabola_k.setRange(-50, 50)
        ...
        self.edit_parabola_a.setValue(0.2)
        self.edit_parabola_h.setValue(10)
        self.edit_parabola_k.setValue(10)
        ...
        self.parabola_but.clicked.connect(self.drawparabola)
        self.aaa_but.clicked.connect(self.action)
        self.bbb_but.clicked.connect(self.bction)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "计算机图形学算法演示程序"))
        self.dda_but.setText(_translate("MainWindow", "DDA"))
        self.bre_but.setText(_translate("MainWindow", "Bresenham画直线"))
        self.aaa_but.setText(_translate("MainWindow", "扫描线填充"))
        self.bbb_but.setText(_translate("MainWindow", "直线裁切"))
        ...
        self.parabola_but.setText(_translate("MainWindow", "bresenham画抛物线"))
        ...
        self.label_16.setText(_translate("MainWindow", "系数a"))
        self.label_17.setText(_translate("MainWindow", "顶点x"))
        self.label_18.setText(_translate("MainWindow", "顶点y"))
